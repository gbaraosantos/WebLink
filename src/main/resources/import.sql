...
INSERT INTO Course(creationDate,area, description,icon , lastChangeDate, name, nClasses, nModules,price,reTryPrice,synch,tClass,createdBy) VALUES (DATE(now()),"Informatica","Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem ", "fa-key",DATE(now()),"App Development",7, 5, 60,20,"Synch",15,1);
INSERT INTO Course(creationDate,area, description,icon , lastChangeDate, name, nClasses, nModules,price,reTryPrice,synch,tClass,createdBy) VALUES (DATE(now()),"Medicine","Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem ", "fa-times",DATE(now()),"Dental",7, 5, 60,20,"Synch",15,1);
INSERT INTO Course(creationDate,area, description,icon , lastChangeDate, name, nClasses, nModules,price,reTryPrice,synch,tClass,createdBy) VALUES (DATE(now()),"Engineering","Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem ", "fa-cog",DATE(now()),"Mechanics",7, 5, 60,20,"Synch",15,1);
INSERT INTO Course(creationDate,area, description,icon , lastChangeDate, name, nClasses, nModules,price,reTryPrice,synch,tClass,createdBy) VALUES (DATE(now()),"Engineering","Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem ", "fa-cog",DATE(now()),"Civil",7, 5, 60,20,"Synch",15,1);
...
INSERT INTO Module(startDate, creationDate, description,lastChangeDate,endDate, name, nClasses, percentage,position,createdBy,course_id) VALUES (STR_TO_DATE('20-06-2017', '%d-%m-%Y'),DATE(now()),"Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem Ipsy Lorem ",DATE(now()),STR_TO_DATE('25-06-2017', '%d-%m-%Y'),"Civil 2.0",2, 25, 2,1,4);
