...
INSERT INTO Users(name,avatarLocation, password,address , Nationality, email, state, dateBirth,postal1,postal2,regDate,lastChangeDate) VALUES ("Konkrets 2","/resources/images/Common/nopic.jpg","$2a$10$fH1P.ZgzBvvgA3imet1rYeuHCTRMsgtMnPRFe/xjzVCjBerlDLteO", "Lousa","Portuguese","konkrets2@hotmail.com", "Active", DATE(now()),1991,234,DATE(now()),DATE(now()));
INSERT INTO Users(name,avatarLocation, password,address , Nationality, email, state, dateBirth,postal1,postal2,regDate,lastChangeDate) VALUES ("Konkrets 3","/resources/images/Common/nopic.jpg","$2a$10$fH1P.ZgzBvvgA3imet1rYeuHCTRMsgtMnPRFe/xjzVCjBerlDLteO", "Lousa","Portuguese","konkrets3@hotmail.com", "Active", DATE(now()),1991,234,DATE(now()),DATE(now()));
...
INSERT INTO UserPermissions (userID, ProfileID) SELECT user.id, profile.id FROM Users user, UserProfile profile where user.id=4 and profile.type="User";
INSERT INTO UserPermissions (userID, ProfileID) SELECT user.id, profile.id FROM Users user, UserProfile profile where user.id=5 and profile.type="User";
...
INSERT INTO Action(evaluationType,creationDate,discount, endDate,finalPrice , lastChangeDate, startDate, visible, course_id, createdBy,classroomSession) VALUES ('1 to 20',DATE(now()),0,null, 60,DATE(now()),STR_TO_DATE('18-06-2017', '%d-%m-%Y'),false, 1,1,'1_MX40NTYwNjA4Mn5-MTQ2NTg0OTQ2ODU0M34rRjV3QjZDK0FNN2VxRVpPVWZLOVhYcyt-fg');
INSERT INTO Action(evaluationType,creationDate,discount, endDate,finalPrice , lastChangeDate, startDate, visible, course_id, createdBy,classroomSession) VALUES ('1 to 20',DATE(now()),0,null, 60,DATE(now()),STR_TO_DATE('18-06-2017', '%d-%m-%Y'),false, 2,1,'1_MX40NTYwNjA4Mn5-MTQ2NTg0OTQ2ODU0M34rRjV3QjZDK0FNN2VxRVpPVWZLOVhYcyt-fg');
INSERT INTO Action(evaluationType,creationDate,discount, endDate,finalPrice , lastChangeDate, startDate, visible, course_id, createdBy,classroomSession) VALUES ('1 to 20',DATE(now()),0,null, 60,DATE(now()),STR_TO_DATE('18-06-2017', '%d-%m-%Y'),false, 3,1,'1_MX40NTYwNjA4Mn5-MTQ2NTg0OTQ2ODU0M34rRjV3QjZDK0FNN2VxRVpPVWZLOVhYcyt-fg');
INSERT INTO Action(evaluationType,creationDate,discount, endDate,finalPrice , lastChangeDate, startDate, visible, course_id, createdBy,classroomSession) VALUES ('1 to 20',DATE(now()),0,null, 60,DATE(now()),STR_TO_DATE('18-06-2017', '%d-%m-%Y'),false, 4,1,'1_MX40NTYwNjA4Mn5-MTQ2NTg0OTQ2ODU0M34rRjV3QjZDK0FNN2VxRVpPVWZLOVhYcyt-fg');
INSERT INTO Action(evaluationType,creationDate,discount, endDate,finalPrice , lastChangeDate, startDate, visible, course_id, createdBy,classroomSession) VALUES ('1 to 20',DATE(now()),0,STR_TO_DATE('30-09-2016', '%d-%m-%Y'), 60,DATE(now()),STR_TO_DATE('01-04-2016', '%d-%m-%Y'),true, 1,1,'1_MX40NTYwNjA4Mn5-MTQ2NTg0OTQ2ODU0M34rRjV3QjZDK0FNN2VxRVpPVWZLOVhYcyt-fg');
INSERT INTO Action(evaluationType,creationDate,discount, endDate,finalPrice , lastChangeDate, startDate, visible, course_id, createdBy,classroomSession) VALUES ('1 to 20',DATE(now()),0,STR_TO_DATE('30-06-2016', '%d-%m-%Y'), 60,DATE(now()),STR_TO_DATE('01-04-2016', '%d-%m-%Y'),true, 1,1,'1_MX40NTYwNjA4Mn5-MTQ2NTg0OTQ2ODU0M34rRjV3QjZDK0FNN2VxRVpPVWZLOVhYcyt-fg');
...
INSERT INTO ModulePerAction(startDate, module , endDate, action) VALUES (STR_TO_DATE('01-04-2016', '%d-%m-%Y'),3,STR_TO_DATE('08-06-2016', '%d-%m-%Y'),5);
INSERT INTO ModulePerAction(startDate, module , endDate, action) VALUES (STR_TO_DATE('09-06-2016', '%d-%m-%Y'),4,STR_TO_DATE('30-09-2016', '%d-%m-%Y'),5);
...
INSERT INTO ModulePerAction(startDate, module , endDate, action) VALUES (STR_TO_DATE('01-04-2016', '%d-%m-%Y'),3,STR_TO_DATE('08-06-2016', '%d-%m-%Y'),6);
INSERT INTO ModulePerAction(startDate, module , endDate, action) VALUES (STR_TO_DATE('09-06-2016', '%d-%m-%Y'),4,STR_TO_DATE('30-06-2016', '%d-%m-%Y'),6);
...
INSERT INTO Student(action, user,finalGrade,price,date) VALUES (5,3,0,60,Date(now()));
